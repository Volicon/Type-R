...
import { define, definitions, Mixable, MixableConstructor, mixinRules, MixinsState } from 'type-r/mixins';
import { omit, transform } from 'type-r/tools';

const { strings, on, off, once, trigger5, trigger2, trigger3 } = eventsApi;
export { eventsApi }
