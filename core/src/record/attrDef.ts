 ...
 */
import { IOEndpoint } from '../transactional/io-tools';
import { EventMap, EventsDefinition } from 'type-r/events';
import { definitionDecorator } from 'type-r/mixins';
import { Transactional } from '../transactional';
import { AttributeOptions, Parse, AnyType, getMetatype, SharedType } from './metatypes';
import { AttributesContainer } from './updates';

import { assign } from 'type-r/tools';
